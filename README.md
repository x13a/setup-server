...
- `setup.sh`: system updates, user creation with passwordless sudo, SSH, iptables/UFW, Fail2Ban, DNS and sysctl settings.
...
| `UFW` | - | Use UFW instead of iptables |
